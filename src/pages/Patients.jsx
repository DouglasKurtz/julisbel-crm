...
const BLANK = { name: '', phone: '', email: '', birth_date: '', notes: '' }
    ...
    <div className="space-y-5">
      <header className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-mute">Cadastro e histórico</p>
        </div>
        ...
        <div className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((p) => (
            <button
              ...
              className="rounded-2xl border border-edge bg-panel p-4 text-left transition-colors hover:border-gold/40"
            >
